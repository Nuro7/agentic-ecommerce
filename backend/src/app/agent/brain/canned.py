...
def say(language: str, key: str, **kwargs: Any) -> str:
    templates: Dict[str, Dict[str, str]] = {
        "en": {
            ...
            "welcome_ask_name": "Welcome to {store_name}! I'm Aria, your personal sales assistant. What's your name, and what are you looking for today?",
        ...
        "hi": {
            ...
            "welcome_ask_name": "{store_name} mein aapka swagat hai! Main Aria hoon, aapki personal sales assistant. Aapka naam kya hai, aur aaj kya dhundh rahe hain?",
        ...
        "ml": {
            ...
            "welcome_ask_name": "{store_name} il swagatham! Njaan Aria, ningalude personal sales assistant. Ningalude peru enthaan, innu enthaan venam?",
        ...
        "ta": {
            ...
            "welcome_ask_name": "{store_name} ku varaverkirom! Naan Aria, ungal personal sales assistant. Ungal peyar enna, innu enna thedugirirkal?",
        ...
        "te": {
            ...
            "welcome_ask_name": "{store_name} loki swagatham! Nenu Aria, meeru personal sales assistant. Meeru peru emiti, ee roju emi vethakuthunnaru?",
        ...
        "bn": {
            ...
            "welcome_ask_name": "{store_name} e swagatom! Ami Aria, aapnar personal sales assistant. Aapnar naam ki, aaj ki khujchen?",
        ...
        "kn": {
            ...
            "welcome_ask_name": "{store_name} ge swagatha! Naanu Aria, nimage personal sales assistant. Nimma hesaru enu, ivattu enu beku?",
