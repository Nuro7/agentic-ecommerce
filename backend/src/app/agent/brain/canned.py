...
def say(language: str, key: str, **kwargs: Any) -> str:
    templates: Dict[str, Dict[str, str]] = {
        "en": {
            ...
            "products_found": "{name} looks like your best bet. Want me to add it to your cart?",
            "ask_product_for_stock": "Which product are you after? I'll check it for you.",
        ...
        "ml": {
            ...
            "products_found": "{name} best option aanu. Cart-il ittekkano?",
            "ask_product_for_stock": "Ethu product aanu venam? Njaan nokkitharaam.",
            "availability": "{name} {size_text}{stock_text}{qty_text}.",
