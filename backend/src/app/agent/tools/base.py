    ...
    return [
        {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "size": {"type": "string", "description": "Exact size filter, e.g. '9', 'M', 'UK 9'"},
                    "color": {"type": "string", "description": "Exact color filter, e.g. 'black', 'tan', 'navy'"},
...
async def execute_tool(
    ...
    if tool_name == "search_products":
        products = await store_client.search_products(
            ...
            color=str(args.get("color") or "") or None,
